...
def MIP_model_restricted(params):
    ...
    try:
        ...
        if solution_checker(Xs, COLORS, ITEM_SIZES, BIN_SIZE, SEED, 'restricted_mip'):
            write_to_global_mip(msol, mdl, 'restricted')

    except Exception as err:
        print(err)
        write_to_global_failed(NUM_COLORS, NUM_ITEMS, BIN_SIZE, DISCREPANCY, SEED, 'restricted_mip', is_bad_solution=False)
