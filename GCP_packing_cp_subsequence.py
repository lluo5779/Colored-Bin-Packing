...
##
    ...
    try:
        ...
        Xs = np.array(Xs)
        # # try:
        if solution_checker(Xs, COLORS, ITEM_SIZES, BIN_SIZE, SEED, "restricted_cp_subsequence"):
            write_to_global_cp(msol, mdl, 'restricted_subsequence')

    except Exception as err:
        print(err)
        write_to_global_failed(NUM_COLORS, NUM_ITEMS, BIN_SIZE, DISCREPANCY, SEED, 'restricted_cp_subsequence', is_bad_solution=False)
     #     print(k, i, m )
##
    return mdl, msol
##
